                        ...
                        <Row>
                            <div className="container justify-content-center mt-4 mb-4 ms-2 me-2" style={{ backgroundColor: "#0F1724", borderRadius: "5px", borderRadius: "10px", boxShadow: "0px 0px 1px 1px  #1ef7f7" }}>
                                ...
                                <div className="col-lg-12 text-center p-4">
                                    <button onClick={() => setProfile("social")} type="button" className={profile === "social" ? "btn btn-outline-info active" : "btn"}>Social</button>
                                    <button onClick={() => setProfile("profile")} type="button" className={profile === "profile" ? "btn btn-outline-info active" : "btn"}>Personal</button>
                                    <button onClick={() => setProfile("business")} type="button" className={profile === "business" ? "btn btn-outline-info active" : "btn"}>Business</button>
                                </div>
